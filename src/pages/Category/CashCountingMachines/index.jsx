      ...
      <div className="max-w-[1024px] mx-auto px-4 mb-10">
        {Devices.map((item, index) => {
          return (
            <div
              key={index}
              className="poppins_regular flex flex-col lg:flex-row mt-10 gap-10"
            >
              <div className="flex flex-col-reverse gap-10 lg:w-1/2 self-center">
