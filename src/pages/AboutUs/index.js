        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 my-10">
          <div className="flex xl:hidden">
            <img
              ...
              src="/image/about/about_small_1.png"
              alt="about"
            />
          </div>
        ...
        <div className="grid lg:grid-cols-2">
          <div className="self-end pb-5 px-5 text-center lg:text-justify">
            <img
              ...
              src="/image/about/about_large_2.png"
              alt="about-us"
            />
          ...
          <div className="relative hidden lg:flex">
            ...
            <img
              ...
              src="/image/about/about_small_2.png"
              alt="about-us"
            />
            <div
              id="circle"
